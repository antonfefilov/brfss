...
```
 ...
 From the frequency table and bar plot above we can learn that the fraction of those who has no formal education is really small and is near 6%. The next two groups are nearly equal, the fraction of those who graduated high school and those who attended college or technical school are about 24% and 28% respectively. If we combine those groups we will see that the number of people who graduated high school, but didn't graduate college is dominant and equal 52%. 
